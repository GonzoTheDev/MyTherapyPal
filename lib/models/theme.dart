...
class DarkTheme extends AppTheme {
  DarkTheme({
    ...
    Color super.sendButtonColor = Colors.teal,
...
class LightTheme extends AppTheme {
  LightTheme({
    Color flashingCircleDarkColor = Colors.teal,
    ...
    Color backArrowColor = Colors.teal,
    ...
    Color replyTitleColor = Colors.teal,
    ...
    Color outgoingChatBubbleColor = Colors.teal,
    Color inComingChatBubbleColor = Colors.white,
    Color inComingChatBubbleTextColor = Colors.black,
    Color repliedMessageColor = const Color.fromARGB(255, 88, 208, 212),
    ...
    Color verticalBarColor = Colors.teal,
