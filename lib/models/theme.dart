...
class LightTheme extends AppTheme {
  LightTheme({
    Color flashingCircleDarkColor = Colors.cyan,
    ...
    Color backArrowColor = Colors.cyan,
    ...
    TextStyle linkPreviewIncomingTitleStyle = const TextStyle(),
    TextStyle linkPreviewOutgoingTitleStyle = const TextStyle(),
    Color replyTitleColor = Colors.cyan,
    ...
    Color outgoingChatBubbleColor = Colors.cyan,
    ...
    Color sendButtonColor = Colors.cyan,
    ...
    Color verticalBarColor = Colors.cyan,
